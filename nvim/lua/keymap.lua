...
map('n', '<leader>hc', builtin.commands, {})
map('n', '<leader>hch', builtin.command_history, {})
map('n', '<leader>sh', builtin.search_history, {})
map('n', '<leader>hh', builtin.man_pages, {})
map('n', '<leader>mm', builtin.marks, {})
map('n', '<leader>ho', builtin.vim_options, {})
map('n', '<leader>rr', builtin.registers, {})
map('n', '<leader>hk', builtin.keymaps, {})
map('n', '<leader>ji', builtin.current_buffer_tags, {})
map('n', '<leader>rl', builtin.resume, {})
map('n', '<leader>sl', builtin.pickers, {})
map('n', '<leader>lr', builtin.lsp_references, {})
map('n', '<leader>la', builtin.lsp_incoming_calls, {})
map('n', '<leader>lo', builtin.lsp_outgoing_calls, {})
...
map('n', '<leader>lf', builtin.treesitter, {})
map('n', '<leader>jd', ":Telescope file_browser<cr>", {})
